function hitung(){
    ...
    if (bmi > 30){
        ...
        document.getElementById("kategori").innerHTML = "Anda berada dalam kategori kegemukan atau Obesitas. Usahakan untuk menurunkan berat badan dan menerapkan pola hidup sehat dengan menjaga makan dan aktivitas fisik.";
    } else if (bmi > 29.9){
        ...
        document.getElementById("kategori").innerHTML = "Anda berada dalam kategori Overweight atau kelebihan berat badan. Cara terbaik untuk menurunkan berat badan adalah dengan mengatur kalor makanan yang dikonsumsi dan berolahraga.";
    } else if(bmi > 24.9){
        ...
        document.getElementById("kategori").innerHTML = "Anda berada dalam kategori Ideal atau Normal. etap pertahankan berat badan Anda dan jaga berat badan Anda dengan mengatur keseimbangan antara pola makan dan aktivitas fisik Anda.";
    } else {
        ...
        document.getElementById("kategori").innerHTML = "Anda berada dalam kategori kategori kekurangan berat badan. Hubungi dokter lebih lanjut mengenai pola makan dan gizi yang baik untuk meningkatkan kesehatan.";
    }
}